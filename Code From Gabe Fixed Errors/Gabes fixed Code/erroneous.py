# There THREE errors in this code
...
def checking_voting_age(x): ## GABE CHANGE # 3 - Changed == operater to >= operator.
    if x >= 18:
...
for i in range(1, num+1):
    factorial *= i ## GABE CHANGE # 4 - Changed the operator from + to *. 
...
word = input("Enter a word: ") ## GABE CHANGE # 4.5 - Changed "eneter" to "enter". (I know this was just a typo, just wanted to fix it.)
